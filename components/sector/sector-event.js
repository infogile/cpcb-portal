...
const key = 'sector-event';
// const messageQueue = new MessageQueueHelpers();
const jobSchedule = new JobScheduleHelpers();

// messageQueue.publishMessage(key, 'default message queue event for sector');

// Sector
// jobSchedule.scheduleRecurringJob('sector job-schedule definition', '1 minute', function () {
//     console.warn('please implement sector job-schedule here', new Date());
// });
